<script module lang="ts">
  export type WealthWheelSideType = "GUILDSMEN" | "ALLIES";
</script>
...
<script lang="ts">
  ...
  interface Props extends SectionProps {
    section: WealthWheelSideType;
  }
  const { section, checkedBoxes, availableBoxes }: Props = $props();
  const sectionLower = $derived(section.toLowerCase());
</script>
